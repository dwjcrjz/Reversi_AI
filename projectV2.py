...
class AI(object):
    ...
    def evaluate(size, board):
        ...
        if state > 60:
            ...
            value = 10*number + 20110*corner - 4777*xLocation + 91*mobility + 70*stable + 74*outside + map_val
        elif 20 < state <= 40:
            value = 10*number + 20120*corner - 4777*xLocation + 139*mobility + 78*stable + 74*outside + 9*inside + map_val
        else:
            value = 10*number + 20100*corner - 4777*xLocation + 105*mobility + 77*stable + 74*outside + 10*inside + map_val
